...
3. Export the project register to the review workspace using the local filename expected by that workspace.
4. Bring approved rows back as `approved_project_evidence.csv` or paste them into `tblApprovedProjectEvidence`.
